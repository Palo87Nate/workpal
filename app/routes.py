...
@api_blueprint.route('/employees/<string:employee_id>', methods=['PUT'])
def update_employee(employee_id):
    data = request.get_json()
    response, status_code = update_employee_controller(employee_id, data)
    return jsonify(response), status_code

@api_blueprint.route('/employees/<string:employee_id>/tasks', methods=['GET'])
def get_employee_tasks(employee_id):
    response, status_code = get_employee_tasks_controller(employee_id)
    return jsonify(response), status_code

@api_blueprint.route('/employees/<string:employee_id>/contact', methods=['GET'])
...
@api_blueprint.route('/employees/<string:employee_id>', methods=['GET'])
...
@api_blueprint.route('/attendance/<string:employee_id>', methods=['GET'])
...
@api_blueprint.route('/candidates/<string:candidate_id>', methods=['GET'])
def get_candidate(candidate_id):
    response = get_candidate_controller(candidate_id)
    return jsonify(response)

@api_blueprint.route('/candidates/<string:candidate_id>/contact', methods=['GET'])
def get_candidate_contact(candidate_id):
    response = get_candidate_contact_controller(candidate_id)
    return jsonify(response)

@api_blueprint.route('/candidates/post/<string:position>', methods=['GET'])
...
@api_blueprint.route('/departments/<string:department_id>/employees', methods=['GET'])
def get_department_employees(department_id):
    response = get_department_employees_controller(department_id)
    return jsonify(response)

@api_blueprint.route('/departments/<string:department_id>/tasks', methods=['GET'])
...
@api_blueprint.route('/departments/<string:department_id>', methods=['GET'])
def get_department(department_id):
    response, status_code = get_department_controller(department_id)
    return jsonify(response), status_code

@api_blueprint.route('/departments/<string:department_id>', methods=['PUT'])
def update_department(department_id):
    data = request.get_json()
    response, status_code = update_department_controller(department_id, data)
    return jsonify(response), status_code

@api_blueprint.route('/departments/<string:department_id>', methods=['DELETE'])
...
@api_blueprint.route('/tasks/<string:task_id>', methods=['GET'])
def get_task(task_id):
    response, status_code = get_task_controller(task_id)
    return jsonify(response), status_code

@api_blueprint.route('/tasks/<string:task_id>', methods=['PUT'])
def update_task(task_id):
    data = request.get_json()
    response, status_code = update_task_controller(task_id, data)
    return jsonify(response), status_code

@api_blueprint.route('/tasks/<string:task_id>', methods=['DELETE'])
